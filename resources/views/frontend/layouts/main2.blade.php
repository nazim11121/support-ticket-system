...
<head>
  ...
  <!-- Bootstrap CSS v5.2.0-beta1 -->
    ...
    <!-- CSS link -->
    <link rel="stylesheet" href="{{asset('assets/frontend/style2.css')}}">
    <link rel="stylesheet" href="{{asset('assets/frontend/signupStyle.css')}}">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#Health">Health card</a>
        </li>
        <li class="nav-item">
