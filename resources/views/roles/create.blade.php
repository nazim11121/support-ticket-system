...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Settings / Roles /</span> Create
</h4>

<div class="row">
  <div class="col-md-12">
    <div class="card mb-4">
      <h5 class="card-header">Roles Details</h5>
      <!-- Account -->
      <hr class="my-0">
      <div class="card-body">
        <form id="formAccountSettings" method="POST" action="{{ route('roles.store') }}" enctype="multipart/form-data">
            @csrf
          <div class="row">
